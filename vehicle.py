...
class nplate_detection():
    def __init__(self):
        ...
        #model = ie.read_model(model='models/person-vehicle-bike-detection-2004.xml')  
        ...
        #self.height, self.width = list(input_layer.shape)[1:3]
    
    def get_boxes1(self, frame, results, thresh=0.2):
        ...
        ttl = 0
        for xmin, ymin, xmax, ymax, confidence in results:
            if confidence > thresh:
                ttl = ttl + 1
                print  ( "conf = ", confidence, " idx = ", ttl )        
